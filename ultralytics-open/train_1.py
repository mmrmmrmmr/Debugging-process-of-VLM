...
model_path_yaml = '/home/mamingrui/t_i/ultralytics-open/my_model/'+name+'.yaml'
out_dirs_path = '/home/mamingrui/t_i/ultralytics-open/out_dirs/'+name
...
model = YOLOWorld(model=model_path_yaml)
